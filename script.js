...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            // calculate the budget: income - expensee
...
var UIControler = (function () {
    ...
    return {
        ...
        displayPercentages: function (percentagates) {
            var fields = document.querySelectorAll(DOMStrings.expensesPercLabel);

            nodeListForEach(fields, function (current, index) {
                if (percentagates[index] > 0) {
                    current.textContent = percentagates[index] + '%';
                } else {
                    current.textContent = '---';
                }
            })
...
var controller = (function (budgetContrl, UIContrl) {
    ...
    var setupEventListerners = function () {
        ...
        document.querySelector(DOM.inputType).addEventListener('change', UIContrl.changeType);
    };

    var updateBudget = function () {
        //1. Calcullate the budget 
    ...
    var updatePercentages = function () {
        ...
        var percentagates = budgetContrl.getPercentages();

        //3. Update the UI with the new percentages
        UIContrl.displayPercentages(percentagates);
    }
    ...
    var ctrlDeleteItem = function (e) {
        ...
        if (itemID) {
            ...
            budgetContrl.deleteUtem(type, ID);
